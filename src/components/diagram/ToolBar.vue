<template>
  <div class="header-container">
    <el-tooltip effect="dark" content="创建 diagram">
      <i title="创建 diagram" class="app-icon app-icon-new"></i>
    </el-tooltip>
    <el-tooltip effect="dark" content="打开 diagram">
      <i
        title="打开 diagram"
      ...
      ></i> </el-tooltip
    >|
    <el-tooltip effect="dark" content="保存 diagram">
      <i
        title="保存 diagram"
    ...
    <el-tooltip effect="dark" content="导出 diagram">
      <i
        title="导出 diagram"
    ...
    |
    <el-tooltip effect="dark" content="复原">
    ...
    |
    <el-tooltip effect="dark" content="导出为图片">
      <i
        title="导出为图片"
      ...
      <ul class="colorSelect" v-show="isOpenColor">
        <li v-for="c in COLORS" :key="c.title">
          <div
            ...
            @click="setColor(c.fill, c.stroke)"
          ></div>
        </li>
      </ul>
    </i>
    |
    <el-tooltip effect="dark" content="元素左对齐">
      <i
        title="元素左对齐"
    ...
    <el-tooltip effect="dark" content="元素垂直居中对齐">
      <i
        title="元素垂直居中对齐"
        class="app-icon app-icon-align-center-tool"
        @click="alignElements('center')"
      ></i>
    </el-tooltip>
    <el-tooltip effect="dark" content="元素右对齐">
      <i
        title="元素右对齐"
        class="app-icon app-icon-align-right-tool"
        @click="alignElements('right')"
      ></i>
    </el-tooltip>
    <el-tooltip effect="dark" content="元素顶部对齐">
      <i
        title="元素顶部对齐"
        class="app-icon app-icon-align-top-tool"
        @click="alignElements('top')"
      ></i>
    </el-tooltip>
    <el-tooltip effect="dark" content="元素水平居中对齐">
      <i
        title="元素水平居中对齐"
        class="app-icon app-icon-align-middle-tool"
        @click="alignElements('middle')"
      ></i>
    </el-tooltip>
    <el-tooltip effect="dark" content="元素底部对齐">
      <i
        title="元素底部对齐"
        class="app-icon app-icon-distribute-vertical-tool"
        @click="alignElements('bottom')"
      ></i>
    </el-tooltip>
    |
    <el-tooltip effect="dark" content="水平分布元素">
      <i
        title="水平分布元素"
        class="app-icon app-icon-distribute-horizontal-tool"
        @click="distributeElements('horizontal')"
      ></i>
    </el-tooltip>
    <el-tooltip effect="dark" content="垂直分布元素">
      <i
        title="垂直分布元素"
        class="app-icon app-icon-distribute-vertical-tool"
        @click="distributeElements('vertical')"
      ></i>
    </el-tooltip>
    |
    ...
    <el-tooltip effect="dark" content="粘贴">
      <i title="粘贴" class="el-icon-document-add" @click="execPaste"></i>
    </el-tooltip>

    <input type="file" id="files" ref="refFile" @change="loadBPMN" hidden />
  </div>
</template>
