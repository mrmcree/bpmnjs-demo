  ...
  <div>
    ...
    >
      ...
      <el-form-item label="流程名称">
        <el-input
          v-model="localProcessData.name"
          @input="updateName"
        ></el-input>
      </el-form-item>
      <el-form-item label="流程描述">
        <el-input
          v-model="localProcessData.description"
          @input="updateDesc"
        ></el-input>
      </el-form-item>
    </el-form>
...
export default {
  ...
  methods: {
    ...
    updateName (name) {
      this.modeler
        .get('modeling')
        .updateProperties(this.element, { name: name })
    },
    updateDesc (name) {
      const doc = this.modeler
        .get('bpmnFactory')
        .create('bpmn:Documentation', { text: name })
      this.modeler
        .get('modeling')
        .updateProperties(this.element, { documentation: [doc] })
    }
  }
}
</script>
